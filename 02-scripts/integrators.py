...
def angular_average(image, mask=None, rad=None, center=None, threshold=None, nx=None,pixel_size=None, photon_energy=None, detector_distance=None, min_x=None, max_x=None):
    ...
    if rad is None:
        rad = radial_distances(image,center)
